...
\u007b
  ...
  spatial_uth(1) = "if(x2 < {config['piston_edge'] + config['compression_length']}, {config['vthe_p']}, {config['vthe_b']})", ! thermal velocity of the electrons in c
  spatial_uth(2) = "if(x2 < {config['piston_edge'] + config['compression_length']}, {config['vthe_p']}, {config['vthe_b']})", ! thermal velocity of the electrons in c
  spatial_uth(3) = "if(x2 < {config['piston_edge'] + config['compression_length']}, {config['vthe_p']}, {config['vthe_b']})", ! thermal velocity of the electrons in c
...
\u007b
  ...
  math_func_expr = "if(x2 < {config['piston_edge']}, {(4 - config['n0_p'])/config['piston_edge']}*x2 + {config['n0_p']}, if(x2 < {config['piston_edge'] + config['compression_length']}, {1.0 + 1.0*config['piston_edge'] / config['compression_length']}, 1.0))",
\u007d
...
\u007b
  uth_type = "thermal",
  uth(1:3) = {config['vthi_b']}, {config['vthi_b']}, {config['vthi_b']}, ! thermal velocity of the background ions in c
  use_spatial_ufl = .true.,
  spatial_ufl(1) = 0.0,
...
\u007b
  profile_type = "math func",
  math_func_expr = "if(x2 < {config['piston_edge']}, {(4 - config['n0_p'])/config['piston_edge']}*x2 + {config['n0_p']}, 0.0)",
\u007d
