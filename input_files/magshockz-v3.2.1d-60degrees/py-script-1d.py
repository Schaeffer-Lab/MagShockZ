...
theta = 1.0471975511965976 # angle that ray makes with the x axis [radians]
...
def load_and_interpolate_density(STATE, filename):
    ...
    STATE["xmax"] = np.array([6528]) # a little more than the final distance specified in input file
