...
#SBATCH -G 4
#SBATCH -q regular
#SBATCH -J magshockz_rqm100_dx0.3_ppc500_g20.1d
...
cd /pscratch/sd/d/dschnei/MagShockZ/input_files/magshockz_rqm100_dx0.3_ppc500_g20.1d
...
export PYTHONPATH=/pscratch/sd/d/dschnei/MagShockZ/input_files/magshockz_rqm100_dx0.3_ppc500_g20.1d:${PYTHONPATH:-}
